...
{ data: goalEventsData, error: goalEventsError },
{ data: cleanSheetData, error: cleanSheetError },
{ data: cardEventsData, error: cardEventsError }
] = await Promise.all([
...
if (teamsError) console.error("teamsError:", teamsError);
if (stateError) console.error("stateError:", stateError);
if (resultError) console.error("resultError:", resultError);
if (playoffError) console.error("playoffError:", playoffError);
if (playersError) console.error("playersError:", playersError);
if (goalEventsError) console.error("goalEventsError:", goalEventsError);
if (cleanSheetError) console.error("cleanSheetError:", cleanSheetError);
if (cardEventsError) console.error("cardEventsError:", cardEventsError);
